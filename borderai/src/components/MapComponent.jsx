  ...
  return (
    ...
    >
      ...
      <LayersControl position="topright">
        ...
        <LayersControl.Overlay name="Distrito 2">
          {distrito2.features.map((coord) => {
            const coordinates = coord.geometry.coordinates.map((item) => [
              item[1],
              item[0],
            ]);
        ...
        <LayersControl.Overlay name="Distrito 3">
          {distrito3.features.map((coord) => {
            const coordinates = coord.geometry.coordinates.map((item) => [
              item[1],
              item[0],
            ]);
        ...
        <LayersControl.Overlay name="Distrito 4">
        <FeatureGroup>
            {seccionesdistrito4.features.map((coord) => {
              const coordinates = coord.geometry.coordinates.map((item) => [
                item[1],
                item[0],
              ]);
        ...
        <LayersControl.Overlay name="Distrito 6">
          {distrito6.features.map((coord) => {
            const coordinates = coord.geometry.coordinates.map((item) => [
              item[1],
              item[0],
            ]);
        ...
        <LayersControl.Overlay name="Distrito 7">
          {distrito7.features.map((coord) => {
            const coordinates = coord.geometry.coordinates.map((item) => [
              item[1],
              item[0],
            ]);
        ...
        <LayersControl.Overlay name="Distrito 8">
          {distrito8.features.map((coord) => {
            const coordinates = coord.geometry.coordinates.map((item) => [
              item[1],
              item[0],
            ]);
        ...
        <LayersControl.Overlay name="Distrito 9">
          {distrito9.features.map((coord) => {
            const coordinates = coord.geometry.coordinates.map((item) => [
              item[1],
              item[0],
            ]);
        ...
        <LayersControl.Overlay name="Distrito 10">
          {distrito10.features.map((coord) => {
            const coordinates = coord.geometry.coordinates.map((item) => [
              item[1],
              item[0],
            ]);
